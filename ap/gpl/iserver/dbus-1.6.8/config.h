...
#define DBUS_SYSTEM_BUS_DEFAULT_ADDRESS "unix:path=/var/run/system_bus_socket"

/* The name of the socket the system bus listens on by default */
#define DBUS_SYSTEM_SOCKET "/var/run/system_bus_socket"

/* Full path to the daemon in the builddir */
#define DBUS_TEST_EXEC "/home/tab/r6300/V1.0.0.88_1.0.14/ap/gpl/iserver/dbus-1.6.8/test"

/* Full path to the launch helper test program in the builddir */
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/home/tab/r6300/V1.0.0.88_1.0.14/ap/gpl/iserver/dbus-1.6.8/bus/dbus-daemon-launch-helper-test"
...
#define PACKAGE_STRING "dbus 1.6.8"
...
/* Full path to the daemon in the builddir */
#define TEST_BUS_BINARY "/home/tab/r6300/V1.0.0.88_1.0.14/ap/gpl/iserver/dbus-1.6.8/bus/dbus-daemon"
