...
#define MAXUSERNAME 61 //25
#define MAXPASSWORD 51 //25
...
/* *** Foxconn Add Start : Steve Hsieh : 2000-10-20 (bpaclient porting) *** */
#define POLL_CYCLE                  1           //the period to polling wan side ip, in unit of second
#define LGIN_CYCLE                  10         //the period to do relogin once a error occur 
/* *** Foxconn Add End : Steve Hsieh : 2000-10-20 (bpaclient porting) *** */
...
**  error code
*/
#define E_BPA_LONG_HB_INTERVAL                  0xffff
#define E_BPA_SOCKET_ERROR                          0xfffe
#define E_BPA_SHORT_HB_INTERVAL                0xfffd                  
#define E_BPA_UNKNOWN_STATUS_SERVER      0xfffc
#define E_BPA_ILLEGAL_PKT_FORMAT               0xfffb 
/* *** Foxconn Add Start : Steve Hsieh : 2005-10-19 (bpaclient porting) *** */
...
struct session
{
    ...
    */
    ...
    //steve add 
    char password_hashed[MAXPASSWORD]; 	
    ...
    int state;/* Foxconn added, Jared Hsu, 2006/03/15 */
...
void bpa_state(int state);/* Foxconn added, Jared Hsu, 2006/03/15 */