...
#define FFMPEG_CONFIGURATION "--enable-shared --enable-gpl --arch=arm --cc=arm-brcm-linux-uclibcgnueabi-gcc --enable-cross-compile --disable-muxers --disable-encoders --disable-filters --disable-vhook --extra-cflags=-fPIC"
