...
extern void remove_func_to_IP_PRE_ROUTE; EXPORT_SYMBOL(remove_func_to_IP_PRE_ROUTE);
...
extern void si_set_bb_vcofreq_frac; EXPORT_SYMBOL(si_set_bb_vcofreq_frac);
...
extern void bcm_robo_snoop_ip_match; EXPORT_SYMBOL(bcm_robo_snoop_ip_match);
extern void bcm_robo_snoop_mac_match; EXPORT_SYMBOL(bcm_robo_snoop_mac_match);
extern void bcm_robo_snooping_add; EXPORT_SYMBOL(bcm_robo_snooping_add);
extern void bcm_robo_snooping_del; EXPORT_SYMBOL(bcm_robo_snooping_del);
extern void bcm_robo_snooping_list; EXPORT_SYMBOL(bcm_robo_snooping_list);
extern void get_iptv_ports; EXPORT_SYMBOL(get_iptv_ports);
extern void get_robo_ptr; EXPORT_SYMBOL(get_robo_ptr);
extern void is_iptv_port; EXPORT_SYMBOL(is_iptv_port);
extern void is_reg_mgmt_mode_enable; EXPORT_SYMBOL(is_reg_mgmt_mode_enable);
extern void is_reg_snooping_enable; EXPORT_SYMBOL(is_reg_snooping_enable);
extern void pdesc25; EXPORT_SYMBOL(pdesc25);
extern void pdesc97; EXPORT_SYMBOL(pdesc97);
extern void record_mac_address; EXPORT_SYMBOL(record_mac_address);
extern void remove_mac_address; EXPORT_SYMBOL(remove_mac_address);
...
extern void robo_read_link_status; EXPORT_SYMBOL(robo_read_link_status);
extern void robo_watchdog; EXPORT_SYMBOL(robo_watchdog);
extern void set_iptv_ports; EXPORT_SYMBOL(set_iptv_ports);
extern void snooping_table; EXPORT_SYMBOL(snooping_table);
